function show4x4() {
    let A = [
      ...
      let canvas = document.getElementById("canvas"), // Select our canvas element
          ...
          scale = Math.min(canvas.width / width, canvas.height / height); // Scales the whole image by this amount
...
function show32x32() {
    ...
    for (let row = 0; row < height; row++) {
        for (let col = 0; col < width; col++) {
            ...
            let rgb_color = "rgba(";
            for (let i = 0; i < A[row][col].length; i++) {
              rgb_color += (i === A[row][col].length - 1) ? A[row][col][i] + ")" : A[row][col][i] + ",";
            }
